...
exports.StrikeDecorator = void 0;
...
var StrikeDecorator = /** @class */ (function (_super) {
    ...
    StrikeDecorator.prototype.decoration = function () {
        return _super.prototype.decoration.call(this).strike();
    };
    return StrikeDecorator;
}(textDecorator_1.TextDecorator));
exports.StrikeDecorator = StrikeDecorator;
